...
import org.database.resume.util.XmlLocalDateAdapter;
...
public class Organization implements Serializable {
    ...
    public static class Position implements Serializable {
        ...
        public Position(LocalDate startDate, LocalDate endtDate, String title, String description) {
            Objects.requireNonNull(startDate, "startDate must not be null");
            Objects.requireNonNull(endtDate, "endtDate must not be null");
