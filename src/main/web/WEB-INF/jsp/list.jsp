...
<table border="1" cellpadding="8" cellspacing="0" class="center">
    ...
    <c:forEach var="resume" items="${resumes}">
        ...
        <tr>
            ...
            <td align="center"><a href="resume?uuid=${resume.uuid}&action=edit"><img src="img/edit.png" title="Редактировать"></a></td>
            <td align="center"><a href="resume?uuid=${resume.uuid}&action=delete"><img src="img/remove.png" title="Удалить"></a></td>
            <td align="center"><a href="resume?uuid=${resume.uuid}&action=copy" title="Копировать"><img src="img/copy.png" title="Копировать"></a></td>
            <td align="center"><a href="resume?action=add" title="Добавить"><img src="img/add.png" title="Добавить"></a></td>
        </tr>
    </c:forEach>
</table>
